...
-grenade launcher has bigger velocity, close to rocket launchers attached to some weapons in real wars. Decreased range damage (and ---to be done ---decreased direct damage as well).
...
MOD
TESTED ONLY versus BOTS. Any problems that would arise in player versus players have not been addressed.

==============================
Original ioquake3 docu:
==============================
